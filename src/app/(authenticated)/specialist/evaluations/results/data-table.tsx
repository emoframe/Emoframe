...
import MultipleResultsButton from "@/components/MultipleResultsButton";
...
export function EvaluationsAnswersDataTable<TData, TValue>({
    ...
    const selectedUsers = Object.entries(rowSelection).filter(([_, isSelected]) => isSelected).map(([i]) => i);
        ...
        <div className="flex flex-col h-full">
            <div className="flex pb-4 gap-4 w-full">
                ...
                <MultipleResultsButton
                    users={selectedUsers.map(i => data[i])}
                    successPath="/specialist/evaluations/results/groupanswer"
                >
                    <Button disabled={selectedUsers.length < 2} className="text-nowrap">
