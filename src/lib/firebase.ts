...
import { Panas, Evaluation, Sam, Sus, Eaz, Brums } from "@/types/forms";
...
export async function saveAnswer (data: Panas | Sam | Sus | Eaz | Brums, EvaluationId: string, UserId: string) : Promise<any> {
