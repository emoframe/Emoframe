...
import { Panas, Evaluation, Sam, Sus, Eaz } from "@/types/forms";
...
export async function saveAnswer (data: Panas | Sam | Sus | Eaz, EvaluationId: string, UserId: string) : Promise<any> {
