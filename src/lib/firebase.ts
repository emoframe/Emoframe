...
import { Panas, Evaluation, Sam, Sus, Eaz, Brums, Gds, Template, TemplateAnswers, Leap, Answer, Result, Page, PageFeedback, TuqRespostas } from "@/types/forms";
...
export async function saveAnswer(data: Panas | Sam | Sus | Eaz | Brums | Gds | Leap | TemplateAnswers | TuqRespostas, EvaluationId: string, UserId: string): Promise<any> {
